...
*   **Isolated Environment**: Automatically creates a `.venv` in the extension directory. No pollution of your global Python setup.
*   **Package Management**: Gemini can self-service dependencies using `pip_install`.
*   **Dedicated Workspace**: All files created by the agent land in a `workspace/` directory.
